		...
		list.addListSelectionListener(new ListSelectionListener() {
		    ...
		    public void valueChanged(ListSelectionEvent e) {
		        selected[0] = list.getSelectedValue(); // Asignar el valor al objeto selected
		            ...
		            DNILabel.setText("● Ubicacion: " + selected[0].getUbicacion());
		            lugarSecuestroLabel.setText("● Fecha de puesta en marcha: " + selected[0].getFechaPuestaEnMarcha());
		            ultVezLabel.setText("● Fecha de cierre: " + selected[0].getFechaCierre());
		            ...
		            biografiaLabel.setText("● Fuerzas a cargo: " + fuerzasNombres.toString());
	                }
