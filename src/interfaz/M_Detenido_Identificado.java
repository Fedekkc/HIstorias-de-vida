...
public class M_Detenido_Identificado extends JPanel {

	private static final long serialVersionUID = 1L;
	private JTextField txtNombre;
	private JTextField txtDNI;
	private JTextField txtTiempoEnCautiverio;
	private DetenidoIdentificado detenido;


	/**
	 * Create the panel.
	 */
	public M_Detenido_Identificado(DetenidoIdentificado detenido) {
		...
		txtNombre.setText(detenido.getNombre());
		...
		txtDNI.setText(detenido.getDNI());
		...
		txtBiografiaPersonal.setText(detenido.getBiografiaPersonal());
		...
		txtTiempoEnCautiverio.setText(Integer.toString(detenido.getTiempoEnCautiverio()));
		...
		if (detenido.getSobrevivio()) chckbxSeEncuentraAparecido.setSelected(true);
		panel.add(chckbxSeEncuentraAparecido);
		
		JDateChooser dateChooser = new JDateChooser();
		dateChooser.setBounds(10, 189, 188, 20);
		dateChooser.setDate(java.sql.Date.valueOf(detenido.getUltVezVisto()));
